...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xC63D59a77F38F46E4e2f4cC2e75B1f600eb1e01C;
...
contract GoldFarmFaaS is IRewardDistributionRecipient, ReentrancyGuard {
    ...
    IBEP20 public rewardToken;// BFARM BSC20
    IBEP20 public rewardToken1;// BUSD BSC20
    IBEP20 public lpToken; // BFARM BSC20
    
    address public devAddy = address(0x2Af04de0716A5dc9a05B439Af8B6f9dF1e989487);//collects pool use fee
    uint256 public devtxfee = 1; //Fee for pool use, sent to BARM farming pool
    ...
    constructor(address _lpToken, address _rewardToken, address _rewardToken1) {
        ...
        rewardToken1 = IBEP20(_rewardToken1);
    ...
    function recoverLostTokensAfterFarmExpired(IBEP20 _token, uint256 amount) external onlyOwner {
